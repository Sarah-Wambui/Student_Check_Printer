...
<header class="bg-white shadow-md px-8">
  <div class="flex justify-between items-center px-6 py-4">
    ...
    <div class="flex items-center">
      <button id="sidebar-toggle" class="p-2 rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500">
    ...
    <div class="relative" x-data="{ open: false }">
      ...
      >
        <span class="font-medium text-gray-700">{{ Auth::user()->time_clock_name }}</span>
