...
<aside class="w-64 bg-gray-900 text-gray-200 min-h-screen p-4">
    ...
    <ul class="space-y-3">
        <!-- Dashboard -->
        <li>
            <a href="{{ route('user.dashboard') }}" class="flex items-center gap-3 px-3 py-2 hover:bg-gray-800 rounded">
        ...
        <!-- Print Check -->
        <li>
            <a href="{{ route('user.checks.create') }}" class="flex items-center gap-3 px-3 py-2 hover:bg-gray-800 rounded">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="#fff" d="M18 7H6V3h12zm0 5.5q.425 0 .713-.288T19 11.5t-.288-.712T18 10.5t-.712.288T17 11.5t.288.713t.712.287M16 19v-4H8v4zm2 2H6v-4H2v-6q0-1.275.875-2.137T5 8h14q1.275 0 2.138.863T22 11v6h-4z"/></svg>
                Print Check
            </a>
        </li>
        ...
        <!-- Check History -->
        <li>
            <a href="{{ route('user.checks.history') }}" class="flex items-center gap-3 px-3 py-2 hover:bg-gray-800 rounded">
        ...
        <!-- Company Names -->
        <li>
            <a href="{{ route('user.companies') }}" class="flex items-center gap-3 px-3 py-2 hover:bg-gray-800 rounded">
        ...
        <!-- Deposits -->
        <li>
            <a href="{{ route('user.deposits') }}" class="flex items-center gap-3 px-3 py-2 hover:bg-gray-800 rounded">
